...
VALUES ('Michael Jackson', 'Thriller', '1982', 'Pop, post-disco, funk, rock', '50.2'),
       ...
       ('Eagles', 'Their Greatest Hits (1971Ð', '1976', 'Country rock, soft rock, folk ro', '41.2'),
       ...
       ('Led Zeppelin', 'Led Zeppelin IV', '1971', 'Hard rock, heavy metal, folk roc', '30.4'),
       ('Michael Jackson', 'Bad', '1987', 'Pop, rhythm and blues, funk and ', '21.1'),
       ('Meat Loaf', 'Bat Out of Hell', '1977', 'Hard rock, glam rock, progressiv', '22'),
       ...
       ('Dire Straits', 'Brothers in Arms', '1985', 'Roots rock, blues rock, soft roc', '21.1'),
       ...
       ('The Beatles', 'Sgt. Pepper''s Lonely Heart', '1967', 'Rock', '18.3'),
